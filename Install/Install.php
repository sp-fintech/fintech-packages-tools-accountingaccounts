...
namespace Apps\Fintech\Packages\Accounting\Accounts\Install;

use Apps\Fintech\Packages\Accounting\Accounts\Install\Schema\AccountingAccounts;
...
class Install extends BasePackage
{
    ...
    public function init()
    {
        $this->databases =
            [
                'apps_fintech_accounting_accounts'  => [
                    'schema'        => new AccountingAccounts,
                    'model'         => new AppsFintechAccountingAccounts
                ]
            ];
